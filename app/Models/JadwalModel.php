...

{
    ...
    public function getJadwalGuru($id)
    {
        ...
        FROM tbl_jadwal INNER JOIN tbl_guru ON tbl_jadwal.id_guru = tbl_guru.id_guru INNER JOIN tbl_murid ON tbl_jadwal.id_murid = tbl_murid.id_murid WHERE tbl_jadwal.id_guru = $id");
