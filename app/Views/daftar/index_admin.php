                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6 login-sec">
                            <div class="login-sec-bg">
                                ...
                                <form id="example-advanced-form" action="<?= base_url('daftar/ambildatabyadmin') ?>" method="post" enctype="multipart/form-data" style="display: none;">
                                    <h3>Data Diri</h3>
                                    <fieldset class="form-input" style="overflow-y: auto;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="custom-select" name="user_ortu" id="user_ortu">
